...
class TestPromptTemplates:
    ...
    def test_task_analysis_prompt_has_placeholders(self):
    ...
    def test_task_analysis_prompt_has_examples(self):
    ...
    def test_task_analysis_prompt_has_guidelines(self):
    ...
    def test_compact_prompt_has_placeholders(self):
    ...
    def test_compact_prompt_has_structure(self):
    ...
    def test_anthropic_config_uses_full_prompt(self):
    ...
    def test_openai_config_uses_full_prompt(self):
    ...
    def test_compact_config_uses_compact_prompt(self):
    ...
    def test_get_prompt_config_specific_provider(self):
    ...
    def test_get_prompt_config_unknown_provider(self):
