...
class TestTaskModel:
    ...
    def test_task_creation_with_all_fields(self):
        ...
        task = Task(
            ...
            actions_to_perform=["Click login button", "Fill credentials", "Click each download link"],
    ...
    def test_has_actions_method(self):
        ...
        task1 = Task(
            ...
            objectives=["Read content"],
            success_criteria=["Content read"]
        )
    ...
    def test_is_complex_method(self):
        ...
        complex_task2 = Task(
            ...
            actions_to_perform=["Fill name", "Fill email", "Upload document", "Select options", "Submit"]
        )
